...
<main id="main" class="site-main" >
   <article class="hentry" id="post-{$article.ID}">
    <div class="gkt-breadcrumbs">当前位置：<a href="{$host}">首页</a> <small>></small> <a href="{$article->Category->Url}" target="_blank">{$article->Category->Name}</a> <small>></small> 正文</div>
    <header class="entry-header">
        ...
        <span class="sticky-meta-right">
                <span class="meta-right">
                            <span class="entry-views">浏览：{$article.ViewNums}</span>
                            <span class="entry-comment">评论：{$article.CommNums}</span>
                </span><!-- .meta-right -->
