...
<div class="juzhong">
    <div class="weixinde">
        ...
        <button class="btn" data-clipboard-action="copy" data-clipboard-target="#target" id="copy_btn">复制并跳转到微信添加好友
        </button>
        <script>
    ...
    <div id="site-bottom" class="clear">
        <div class="container">
            <div class="menu-m_footer-container">
                <ul id="footer-menu" style="display: none" class="footer-nav">
