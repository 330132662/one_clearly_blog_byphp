<?php include('post-safe.php');?><article class="post">
	...
	{if $article.Metas.Mobile !=""}
          <p style="vertical-align:middle;display:block;text-align: center;">
            <a style="color:#ffffff!important;background-color: #00a0a0;display: inline-block;padding: 5px;	" href="tel:{$article.Metas.Mobile}" class="">一键拨打：{$article.Metas.Mobile}</a>
          </p> 
	{/if}
	<div class="entry">
		{$article.Content}
