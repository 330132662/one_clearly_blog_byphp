...
<main id="main" class="site-main" >
   <article class="hentry" id="post-<?php  echo $article->ID;  ?>">
    <div class="gkt-breadcrumbs">当前位置：<a href="<?php  echo $host;  ?>">首页</a> <small>></small> <a href="<?php  echo $article->Category->Url;  ?>" target="_blank"><?php  echo $article->Category->Name;  ?></a> <small>></small> 正文</div>
