...
<?php if (isset($SEOON) && $SEOON == '0') { ?>
    ...
    <?php }elseif($type=="index" && $page > '1') {  ?>
        <title><?php  echo $name;  ?>_<?php  echo $title;  ?>-第<?php  echo $page;  ?>页</title>
    <?php } ?>
<?php } ?>
...
<script type='text/javascript' src='<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/script/jquery2.php'></script>
<?php  echo $header;  ?>
</head>