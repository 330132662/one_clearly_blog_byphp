...
return array(
    ...
    'license_title'                   => 'zhonggongPHP 最终用户授权协议 ',
    'install_tips'                    => '安装提示',
    'install_disable'                 => '您已经安装好zhonggongPHP了，不能重复安装。',
    ...
    'guestbook'                       => '留言本',
    'wellcome'                        => '您好，欢迎到访网站！',
    'hello_zblog'                     => '欢迎使用zhonggongPHP！',
    'hello_zblog_content'             => '<p>欢迎使用zhonggong，这是程序自动生成的文章，您可以删除或是编辑它:)</p><p>系统生成了一个留言本和一篇《欢迎使用zhonggongPHP！》，祝您使用愉快！</p>',
