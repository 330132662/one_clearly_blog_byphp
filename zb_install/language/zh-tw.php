...
return array(
    ...
    'license_title'                   => 'zhonggongPHP 最終用戶許可協議',
    'install_tips'                    => '安裝提示',
    'install_disable'                 => '通過設定檔案的檢驗，您已經安裝並設定好zhonggongPHP了，不能再重複使用安裝程式。',
    ...
    'hello_zblog_content'             => '<p>歡迎來到 zhonggongPHP。這是你的第一篇文章。編輯或者刪除本篇文章，然後開始你的部落客生活！</p>',
    'guestbook_content'               => '這是一個範例頁面。它和網誌文章不同。大多數的人會新增一個「關於」頁面向訪客介紹自己。作為一個新的 zhonggongPHP 使用者，你可以前往你的控制台刪除這個頁面，並建立一個屬於你的全新內容。祝使用愉快！',
