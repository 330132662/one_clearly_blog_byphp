...
<head>
  ...
  <meta name="generator" content="zhonggongPHP" />
  ...
  <title>zhonggongPHP <?php echo ZC_BLOG_VERSION . ' ' . $zbp->lang['zb_install']['install_program']; ?> </title>
...
function Setup0()
{
  ...
  <dl>
    <dt></dt>
    <dd id="ddleft">
      <div id="headerimg"><img src="../zb_system/image/admin/logo.svg" alt="zhonggongPHP" />
...
function Setup1()
{
  ...
  <dl>
    ...
    <dd id="ddright">
      ...
      <div id="title">zhonggongPHP <?php echo ZC_BLOG_VERSION . ' ' . $zbp->lang['zb_install']['install_license']; ?></div>
      <div id="content">
        <textarea readonly>
    <?php echo $zbp->lang['zb_install']['license_title'] . "\r\n"; ?>

感谢您选择zhonggongPHP。 zhonggongPHP 基于 PHP 技术开发，采用 MySQL 或 SQLite 或 PostgreSQL 作为数据库，全部源码开放。她既是博客程序，也是CMS建站系统。已走过十余年风雨的她们，有着强大的可定制性、丰富的主题和插件，致力于给国内用户提供优秀的博客写作体验。期待能成为您写博客的第一选择。

zhonggongPHP官方网址：https://www.zblogcn.com/

为了使您正确并合法的使用本软件，请您在使用前务必阅读清楚下面的协议条款：

一、本授权协议适用且仅适用于 zhonggongPHP。

二、协议许可的权利
1. 本程序基于 MIT 协议开源，您可以在 MIT 协议允许的范围内对源代码进行使用，包括修改源代码或界面风格以适应您的网站要求。
2. 您拥有使用本软件构建的网站及其全部内容的所有权，并独立承担与这些内容的相关法律义务。
3. 如您需要使用zhonggong应用中心，您需要在应用中心内同意《应用中心额外条款及最终用户许可协议》。

三、协议规定的约束和限制
1. 无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 zhonggongPHP 程序本身，未经书面许可，必须保留页面底部的版权（Powered by zhonggongPHP），不得删除；但可以以任何访客可见的形式对其进行修改和美化。
...
3. 电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装 zhonggongPHP ，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。
...
(一)、ZBLOGCN.COM提供免费开源的建站程序zhonggong和zhonggongPHP，不提供网站相关的内容服务，该建站程序之著作权归ZBLOGCN.COM所有。
    ...
    <dd id="ddright">
      ...
      <div id="content">
        <table border="0" style="width:100%;" class="table_striped table_hover">
          ...
          <tr>
            <td scope="row">zhonggongPHP <?php echo $zbp->lang['zb_install']['path']; ?></td>
...
function InsertInfo()
{
    ...
    $t->Source = "system";
    $t->SidebarID = 1;
    $t->Content = '<li><a href="https://app.zblogcn.com/" target="_blank">zhonggong应用中心</a></li><li><a href="https://bbs.zblogcn.com/" target="_blank">ZBlogger社区</a></li><li><a href="https://z5encrypt.com/" target="_blank" title="全新的PHP加密方案，致力于PHP源码的保护">Z5 PHP加密</a></li>';
    ...
    $t->Source = "system";
    $t->SidebarID = 1;
    $t->Content = '<li><a href="https://github.com/zblogcn" target="_blank" title="zhonggong on Github">zhonggong on Github</a></li><li><a href="https://zbloghost.cn/" target="_blank" title="zhonggong官方主机">zhonggong主机</a></li>';
    $t->HtmlID = "divLinkage";
    $t->Type = "ul";
    $t->Save();
    ...
    $t->Source = "system";
    $t->SidebarID = 1;
    $t->Content = '<li><a href="https://www.zblogcn.com/" target="_blank"><img src="{#ZC_BLOG_HOST#}zb_system/image/logo/zblog.gif" height="31" width="88" alt="zhonggongPHP" /></a></li><li><a href="{#ZC_BLOG_HOST#}feed.php" target="_blank"><img src="{#ZC_BLOG_HOST#}zb_system/image/logo/rss.png" height="31" width="88" alt="订阅本站的 RSS 2.0 新闻聚合" /></a></li>';
    $t->HtmlID = "divMisc";
    $t->Type = "ul";
    $t->IsHideTitle = true;
    $t->Save();
