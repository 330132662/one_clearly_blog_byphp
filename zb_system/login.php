...
<div class="bg">
    <div id="wrapper">
        <div class="logo"><img src="image/admin/none.gif" title="<?php echo htmlspecialchars($blogname); ?>"
                               alt="<?php echo htmlspecialchars($blogname); ?>"/></div>
        <div class="login">
            <form method="post" action="#">
                <dl>
                    <dt></dt>
                    <dd class="username"><label for="edtUserName"><?php echo $lang['msg']['username']; ?></label><input
                                type="text" id="edtUserName" name="edtUserName" size="20"
                                value="<?php echo GetVars('username', 'COOKIE'); ?>" tabindex="1"/></dd>
                    <dd class="password"><label for="edtPassWord"><?php echo $lang['msg']['password']; ?></label><input
                                type="password" id="edtPassWord" name="edtPassWord" size="20" tabindex="2"/></dd>
                </dl>
                <dl>
                    <dt></dt>
                    <dd class="checkbox"><input type="checkbox" name="chkRemember" id="chkRemember"
                                                tabindex="98"/><label
                                for="chkRemember"><?php echo $lang['msg']['stay_signed_in']; ?></label></dd>
                    <dd class="submit"><input id="btnPost" name="btnPost" type="submit"
                                              value="<?php echo $lang['msg']['login']; ?>" class="button"
                                              tabindex="99"/></dd>
                </dl>
...
<script>
    $("#btnPost").click(function () {
        ...
        //$("#edtUserName").remove();
        //$("#edtPassWord").remove();
        //$("#chkRemember").remove();         return false;
