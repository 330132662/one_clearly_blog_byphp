...
return array(
    ...
    'error' => array(
        ...
        '64' => 'Activate failed, the application does not apply to zhonggongPHP.',
        ...
        '78' => 'This application requires%s and above version of zhonggongPHP.',
...
             You can <a href="https://wiki.zblogcn.com/doku.php?id=zblogphp:error:%E9%A6%96%E9%A1%B5#error-92" target="_blank"> click here to get a rough list of missing extensions. </a>
        ...
        'end' => '
            ...
            If you are the webmaster, You can click on <a href="{%morehelp%}" target="_blank"> [more] </a> to get more help from zhonggong Wiki(Chinese only). Therefore, to publish a thread in English in <a href="https://bbs.zblogcn.com/" target="_blank">zhonggong official forum </a> with detailed error description and screenshots for help is a choice.
        ',
    ),
);
