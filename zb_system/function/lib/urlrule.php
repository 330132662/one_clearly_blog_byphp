...
class UrlRule
{
    ...
    public function Make_webconfig()
    {
        ...
        $s .= ' <rule name="' . $zbp->cookiespath . ' zhonggongPHP Imported Rule" stopProcessing="true">' . "\r\n";
        ...
        $s .= ' <rule name="' . $zbp->cookiespath . ' zhonggongPHP Imported Rule index.php" stopProcessing="true">' . "\r\n";
