...
function misc_vrs()
{
    ...
    <body class="short">
        <div class="bg">
            <div id="wrapper">
                <div class="logo"><img src="image/admin/none.gif" title="zhonggongPHP" alt="zhonggongPHP" /></div>
                <div class="login">
...
function misc_php_zbp_info()
{
    ...
    <body class="short">
        <div class="bg">
            <div id="wrapper">
                <div class="logo"><a href="#zblogphp"><img src="image/admin/none.gif" title="zhonggongPHP" alt="zhonggongPHP" /></a></div>
                <?php
                if (PHP_ENGINE === ENGINE_HHVM) {
                ...
                echo '<div class="center"><div><br/><br/><a name="zblogphp"><h1>zhonggongPHP</h1></a><br/></div>';

                $ca = get_defined_constants(true);
                $ca = $ca['user'];
                echo '<table class="table_striped table_hover"><tbody><tr class="h"><th colspan="2">zhonggongPHP Constants</th></tr>';
